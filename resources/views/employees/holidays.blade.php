        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Registration Details <span>{{ date('Y') }}</span></h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_holiday"><i class="fa fa-plus"></i> Add Partner</a>
                    </div>
                </div>
            </div>
			<!-- /Page Header -->
    ...
    <td class="text-right">
        <div class="dropdown dropdown-action">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item userUpdate" data-toggle="modal" data-target="#edit_holiday">
                    <i class="fa fa-pencil m-r-5"></i> Edit
                </a>
                <a class="dropdown-item deleteRecord" href="#" data-toggle="modal" data-target="#deleteRecord">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/holidays/save') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label> Partners <span class="text-danger">*</span></label>
